...
sourceCpp("(4) Code for simulation/VenterMode.cpp")
sourceCpp("(6) Basic codes/rvmc.cpp")
source("(6) Basic codes/DescribeCirc.R")


# Perform simulations on the algorithm by damien & walker extended for
...
simulateVM <- function (nsim, n, kappa, J, meandif, Q,
  ...
  for (i in 1:nsim){
    ...
    # Read in data data.
    readfilename <- paste0(wd, "Kees/Simulation/Datasets/Datasets_", 

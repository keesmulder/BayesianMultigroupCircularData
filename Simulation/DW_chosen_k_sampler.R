...
sourceCpp('Simulation/DW_chosen_k_sampler.cpp')
...
DW <- function(th, R_0=rep(0, length(th)), mu_0=rep(0, length(th)),
               ...
               mu_start = rep(0, length(th)), kp_start = 2, start_w = 4, Z = 40) {
  # FUNCTION DW ------------------------------------------------------------
...
#   print(list(mu_start, start_w, kp_start,
#               lambda, mu_n, R, R_t, m,
#               Z, Qb, lag))

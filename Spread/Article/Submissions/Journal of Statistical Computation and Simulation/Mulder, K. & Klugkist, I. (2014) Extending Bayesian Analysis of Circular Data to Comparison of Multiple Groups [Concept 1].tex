...
\vspace{6pt}} and I. Klugkist$^{\rm a}$\\\vspace{6pt}  $^{a}${\em{Utrecht University, Department of Methodology and Statistics, Utrecht, The Netherlands}}\\\received{v3.3 released January 2014} }
...
%\label{J1}
%\input{C:/Dropbox/Masterthesis/Writing/Kees/Thesis/j1table.tex}
%\vspace{-0.3cm}
%\end{minipage}
%\end{center}
%\end{table}
...
%\label{J3}
%
%\input{C:/Dropbox/Masterthesis/Writing/Kees/Thesis/j3table.tex}
%
%\vspace{-0.3cm}
%\end{minipage}
%\end{table}
